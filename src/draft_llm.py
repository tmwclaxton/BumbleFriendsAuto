...
- When they have just sent their number: if we still don't know their hub / whereabouts, ask that first in one short bubble and do not say you've added them yet. If we already know the hub, thank them only — "I'll get u added shortly" or "Looking forward to meeting you :)" (or both in one short bubble). Do not re-pitch the event, do not paste the itinerary.
